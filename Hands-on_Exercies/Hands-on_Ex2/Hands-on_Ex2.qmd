...
This chapter introduces you to several ggplot2 extensions for creating more elegant and effective statistical graphics. By the end of this exercise, you will be able to:
...
The code chunk below imports *exam_data.csv* into R environment using [*read_csv()*](https://readr.tidyverse.org/reference/read_delim.html) function of [**readr**](https://readr.tidyverse.org/) package. **readr** is one of the tidyverse package.
...
### 2.5.1 Creating Composite Graphics: pathwork methods ![](https://r4va.netlify.app/chap02/img/image4.png){width="33"}
