...
[ggiraph](https://davidgohel.github.io/ggiraph/) ![](https://r4va.netlify.app/chap03/img/image1.jpg){width="49"} is an htmlwidget and a ggplot2 extension. It allows ggplot graphics to be interactive.
...
If it is used within a shiny application, elements associated with an id (data_id) can be selected and manipulated on the client and server sides. Refer to this [article](https://davidgohel.github.io/ggiraph/articles/offcran/shiny.html) for a more detail explanation.
